...
namespace Sopa_De_Letras.Categorias
{
    public class Colores
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("AMARILLO");
            miJuego.agregarPalabraOculta("AZUL");
            miJuego.agregarPalabraOculta("ROJO");
            miJuego.agregarPalabraOculta("MAGENTA");
            miJuego.agregarPalabraOculta("CYAN");
            miJuego.agregarPalabraOculta("LAVANDA");
            miJuego.agregarPalabraOculta("ROSADO");
            miJuego.agregarPalabraOculta("MORADO");
            miJuego.agregarPalabraOculta("BORGOÑA");
