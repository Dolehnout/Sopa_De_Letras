...
namespace Sopa_De_Letras.Categorias
{
    public class Objetos
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("ESCRITORIO");
            miJuego.agregarPalabraOculta("MUEBLE");
            miJuego.agregarPalabraOculta("COMPUTADORA");
            miJuego.agregarPalabraOculta("TELEVISOR");
            miJuego.agregarPalabraOculta("TECLADO");
            miJuego.agregarPalabraOculta("PELUCHE");
            miJuego.agregarPalabraOculta("CEPILLO");
            miJuego.agregarPalabraOculta("CARGADOR");
            miJuego.agregarPalabraOculta("PARED");
