...
namespace Sopa_De_Letras.Categorias
{
    public class Empresas
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("PRONACA");
            miJuego.agregarPalabraOculta("AMAZON");
            miJuego.agregarPalabraOculta("MICROSOFT");
            miJuego.agregarPalabraOculta("TESLA");
            miJuego.agregarPalabraOculta("NVIDIA");
            miJuego.agregarPalabraOculta("GOOGLE");
            miJuego.agregarPalabraOculta("APPLE");
            miJuego.agregarPalabraOculta("IKEA");
            miJuego.agregarPalabraOculta("NESTLE");
