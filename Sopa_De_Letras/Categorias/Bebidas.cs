...
namespace Sopa_De_Letras.Categorias
{
    public class Bebidas
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("CAIPIRINHA");
            miJuego.agregarPalabraOculta("CERVEZA");
            miJuego.agregarPalabraOculta("JUGOS");
            miJuego.agregarPalabraOculta("MOJITO");
            miJuego.agregarPalabraOculta("VINO");
            miJuego.agregarPalabraOculta("VODKA");
            miJuego.agregarPalabraOculta("TEQUILA");
            miJuego.agregarPalabraOculta("WHISKY");
            miJuego.agregarPalabraOculta("AGUA");
