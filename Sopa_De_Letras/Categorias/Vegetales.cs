...
namespace Sopa_De_Letras.Categorias
{
    public class Vegetales
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("CEBOLLA");
            miJuego.agregarPalabraOculta("BROCOLI");
            miJuego.agregarPalabraOculta("LECHUGA");
            miJuego.agregarPalabraOculta("BERENJENA");
            miJuego.agregarPalabraOculta("PEPINO");
            miJuego.agregarPalabraOculta("CALABAZA");
            miJuego.agregarPalabraOculta("PATATA");
            miJuego.agregarPalabraOculta("TOMATE");
            miJuego.agregarPalabraOculta("REMOLACHA");
