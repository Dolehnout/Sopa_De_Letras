...
namespace Sopa_De_Letras.Categorias
{
    public class RedesSociales
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("FACEBOOK");
            miJuego.agregarPalabraOculta("WHATSAPP");
            miJuego.agregarPalabraOculta("INSTAGRAM");
            miJuego.agregarPalabraOculta("TWITTER");
            miJuego.agregarPalabraOculta("DISCORD");
            miJuego.agregarPalabraOculta("SNAPCHAT");
            miJuego.agregarPalabraOculta("LINKEDIN");
            miJuego.agregarPalabraOculta("YOUTUBE");
            miJuego.agregarPalabraOculta("PINTEREST");
