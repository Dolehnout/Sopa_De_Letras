...
namespace Sopa_De_Letras.Categorias
{
    public class Frutas
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("PERA");
            miJuego.agregarPalabraOculta("MANZANA");
            miJuego.agregarPalabraOculta("BANANA");
            miJuego.agregarPalabraOculta("ARANDANO");
            miJuego.agregarPalabraOculta("KIWI");
            miJuego.agregarPalabraOculta("FRUTILLA");
            miJuego.agregarPalabraOculta("MELON");
            miJuego.agregarPalabraOculta("SANDIA");
            miJuego.agregarPalabraOculta("UVA");
