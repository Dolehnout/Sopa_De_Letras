...
namespace Sopa_De_Letras.Categorias
{
    public class Nombres
    {
        ...
        public static void generarSopa(DataGridView Sopa, Juego miJuego, Random letras)
        {
            ...
            miJuego.agregarPalabraOculta("AMELIA");
            miJuego.agregarPalabraOculta("ELIZABETH");
            miJuego.agregarPalabraOculta("DEVIN");
            miJuego.agregarPalabraOculta("FEDERICO");
            miJuego.agregarPalabraOculta("KATHYA");
            miJuego.agregarPalabraOculta("ABIGAIL");
            miJuego.agregarPalabraOculta("ROBERSON");
            miJuego.agregarPalabraOculta("BRITTANY");
            miJuego.agregarPalabraOculta("MELANIE");
